 ...
 * @author Sultan
 */
public class PurchaseProductForm extends javax.swing.JFrame {

    /**
     * Creates new form PurchaseProductForm
     */
    ...
    public PurchaseProductForm() {
        ...
        AutoCompleteDecorator.decorate(this.supplierName);
    ...
    private void initComponents() {
        ...
        jLabel31.setText("SUPPLIER SELECTION & PAYMENT CALCULATION :");
        ...
        if (productTable.getColumnModel().getColumnCount() > 0) {
            ...
            productTable.getColumnModel().getColumn(7).setMaxWidth(60);
        }
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createSequentialGroup()
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(discount, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE)
                                            .addComponent(paidAmount, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE)
                                            .addComponent(returnedAmount, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE)))
                                    .addGap(18, 18, 18)
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(error4, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE)
    ...
    private void purchaseRateCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_purchaseRateCaretUpdate
        ...
        if (!purchaseRate1.equals("") && purchaseRateMatcher.matches()) {
            ...
            if (!gst1.equals(" ")) {
                ...
                double n6 = n1 * n5;
                this.totalAmount.setText(String.valueOf(n6));
            }
        }
    ...
    private void quantitySelectedStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_quantitySelectedStateChanged
        // TODO add your handling code here:
        if (!this.purchaseRate.getText().equals("")) {
            int quantitySelected1 = (int) this.quantitySelected.getValue();
            double purchaseRate1 = Double.parseDouble(this.purchaseRate.getText());
            double totalAmount1 = purchaseRate1 * quantitySelected1;
            ...
            if (flag1 == 0) {
                ...
                if (this.error1.getText().equals("") && this.error2.getText().equals("") && this.error3.getText().equals("")) {
                    try {
                        ...
                        double basicPurchaseRate1 = Double.parseDouble(this.basicPurchaseRate.getText());
                        double gst2 = Double.parseDouble(gst1);
                        int quantitySelected1 = (int) this.quantitySelected.getValue();
                        double taxableAmount1 = basicPurchaseRate1 * quantitySelected1;
                        double cgst = gst2 / 2;
                        ...
                        if (flag2 == 1) {
                            ...
                            Object[] row = {productName1, hsn1, basicPurchaseRate1, quantitySelected1, taxableAmount1, cgst,
    ...
    private void removeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeButtonActionPerformed
        // TODO add your handling code here:
        int[] selectedRow = PurchaseProductForm.productTable.getSelectedRows();
        if (selectedRow.length != 0) {
            ...
            this.productSelector.setSelectedItem(" ");
            this.supplierName.setSelectedItem(" ");
    ...
    private void formWindowGainedFocus(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowGainedFocus
        ...
        int b = this.supplierName.getItemCount();
        for (int i = b - 1; i > 0; i--) {
            this.supplierName.removeItemAt(i);
        }
        supplierPopulate();
    ...
    private void selectButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectButtonActionPerformed
        ...
        rb1.clearSelection();
        if (flag == 1) {
            String val = supplierName1.replaceAll(" ", "");

            if (!val.equals("")) {
                String sID = supplierName1.replaceAll("[^0-9]", "");
                int supplierID1 = Integer.parseInt(sID);
                try {
                    ...
                    String mobile1, streetAddress1, city1, state1, gstin1, pan1, supplierBalancePayment1;
                    mobile1 = streetAddress1 = city1 = state1 = gstin1 = pan1 = supplierBalancePayment1 = "";
                    while (rs.next()) {
                    ...
                    this.previousBalance.setText(supplierBalancePayment1);

                    double grandTotal1 = Double.parseDouble(this.grandTotal.getText());

                    double balance = grandTotal1 + Double.parseDouble(supplierBalancePayment1);
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        if (this.error4.getText().equals("") && this.error5.getText().equals("")) {
            ...
            String supplierName1 = (String) this.supplierName.getSelectedItem();
            int supplierID1 = Integer.parseInt(supplierName1.replaceAll("[^0-9]", ""));
            ...
            try {
                s = c.createStatement();
                String sql1 = "INSERT INTO purchaseTransaction(billNo,tdate,supplierID"
                        + ",totalAmount,discountP,discountR,grandTotal,paidAmount) "
                        + "VALUES('" + billNo1 + "','" + date1 + "'," + supplierID1 + "," + totalAmount1 + "," + discountP1 + "," + discountR1 + "," + grandTotal1 + "," + paidAmount1 + ")";
                ...
                for (int i = 0; i < rows; i++) {
                    ...
                    String sql2 = "INSERT INTO ptdetails(billNo,tDate,supplierID,productID,quantity"
                            + ",taxableAmount,cgstp,cgsta,sgstp,sgsta,totalAmount) "
                            + "VALUES('" + billNo1 + "','" + date1 + "'," + supplierID1 + "," + productID1 + "," + quantity1 + "," + taxableAmount1 + "," + cgstp1 + "," + cgsta1 + "," + sgstp1 + "," + sgsta1 + "," + totalAmount2 + ")";
                    s.executeUpdate(sql2);

                    String sql3 = "UPDATE product SET quantity=" + newQuantity1 + " WHERE productName='" + productName1 + "'";
                    s.executeUpdate(sql3);

                    double supplierBalancePayment1 = Double.parseDouble(this.netBalance.getText());
                    String sql4 = "UPDATE supplier SET supplierBalancePayment=" + supplierBalancePayment1 + " WHERE supplierID=" + supplierID1;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PurchaseProductForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
